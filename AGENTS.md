...
When a repeated pattern appears, propose a skill with:
...
Prefer several narrow composable skills over one large monolithic skill. If a skill grows to cover unrelated workflows, propose splitting it.

Move repeatable mechanical work into scripts whenever possible. Keep creative, contextual, and judgment-heavy work in model instructions.
