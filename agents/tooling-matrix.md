...
| QA & Accessibility | Playwright, `impeccable`, Sentry read-only conditional | Browser | Browser, Sentry conditional | filesystem read | Test files only if delegated | Repro steps, screenshots, accessibility findings |
